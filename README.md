...
# Git 클론
git clone https://github.com/jiwon010106/legacy_front.git front
git clone https://github.com/jiwon010106/legacy_back.git back
...
- **웹사이트**: 유산사이트(https://legacy-seven.vercel.app).
- **기타문의**: 카카오 플러스
